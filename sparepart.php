...
<form method="post">
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            ...
            <button type="button" onclick="location.href='sparepart-baru.php'" class="btn btn-warning"><span class="fa fa-clone"></span> Tambah Data</button>
        </div>
    </div>
    <br/>
    ...
    ?>
            ...
            <td class="text-center" style="vertical-align:middle;">
    		  <a href="sparepart-ubah.php?id=<?php echo $row['id_sparepart'] ?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
